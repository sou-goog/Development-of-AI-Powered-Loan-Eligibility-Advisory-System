...
const Verification = () => {
  ...
  const handleUploadSuccess = (data) => {
    ...
    // Stop auto-running eligibility; user will trigger via button
  };
  ...
  const handleEligibilityCheck = async () => {
    ...
    try {
      ...
      if (applicationId) {
        ...
        // Combine extracted data with defaults when no application exists
        const eligibilityData = {
          ...
          Loan_Amount_Requested: extractedData.Loan_Amount_Requested || 500000,
          Loan_Tenure_Years: extractedData.Loan_Tenure_Years || 5,
          Credit_Score: extractedData.Credit_Score || 650,
